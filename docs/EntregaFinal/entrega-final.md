...
??? note "Tabela com a Execução do Projeto"
    ...
    **Verificação Caesb** | Essa etapa confirma se os artefatos produzidos estão corretos, completos, consistentes e atendem às necessidades do projeto. Nessa etapa Foi realizado a verificação do nosso grupo  | [Verificação](https://requisitos-de-software.github.io/2023.1-Caesb/AnaliseV%26V/Verificacao/Caesb/0planejamento-geral/) |
    ...
    Tabela 1 - Execução do Projeto (Fonte: Guilhereme e Paulo, 2023)

    </center>

## Técnicas
Os artefatos produzidos em um projeto possuem metodologias e técnicas associadas. Com isso, as técnicas utilizadas para a execução do nosso projeto estão listadas na tabela 2.

??? note "Tabela com as Técnicas"

    <center>

    | Técnica Utilizada | Artefato Relacionado |
    | --- | --- |
    | XP | [Metodologia]() |
    | DevOps | [Metodologia]() |
    | Rich Picture | [Rastreabilidade]() |
    | Questionário | [Questionário](), [Perfil de Usuário]() |
    | Personas | [Personas]() |
    | Storytelling | [Questionário]() |
    | In Or Out | [In Or Out](),[ Priorização]() |
    | First Thing First | [First Thing First]() , [Priorização]() |
    | Léxicos | [Léxicos]() |
    | Texto Estruturado | [Cenários]() |
    | Diagrama UML | [Casos de Uso]() |
    | FURPS+ | [Especificação Suplementar]() |
    | NFR Framework | [NFR Framework]() |
    | Histórias de Usuário | [Histórias de Usuário]() |
    | Product Backlog | [Backlog]() |
    | Inspeção | [Planejamento Entrega 1](), [Cronograma Planejado](), [Cronograma Realizado](), [Atas](), [Ferramentas](), [Metodologia](), [Aplicativo Selecionado](),[ Rich Picture](), [Elicitação](), [Priorização](), [Planejamento Entrega 2 - Elicitação](), [Perfil de Usuário](), [Personas](), [Storytelling](), [Glossário](), [Introspecção](), [Entrevista](), [Brainstorming](), [First Things First](), [MoScow](), [Three Level Scale](), [Cenários](), [Casos de Uso](), [Léxicos](),[ Especificação Suplementar](), [Planejamento Entrega 4](), [Histórias de Usuário](), [NFR](), [Backlog](), [Planejamento Geral Planejamento Entrega 1](), [Cronograma Planejado](), [Cronograma Realizado](), [Atas](), [Ferramentas](), [Metodologia](), [Aplicativo Selecionado](), [Rich Picture](), [Planejamento Entrega 2](), [Perfil de Usuário](), [Personas](), [Storytelling](), [Glossário](), [Introspecção](), [Entrevista](), [First Things First](), [InOrOut](),[Planejamento Entrega 3](), [Cenários](), [Casos de Uso](), [Léxicos](), [Especificação Suplementar](), [Planejamento Entrega 4](), [Histórias de Usuário](), [NFR](), [Backlog]()  |
    | Protótipo | [Protótipo]() |
    | Envio de e-mail | [Contato]() |
    | Meta-modelo de Toranzo | [Backward-From](), [Forward-From]() |
    | Gravação | [Apresentação]() |

    Tabela 2: Técnicas (Fonte: Raquel, 2023).
...
??? note "Tabela com os Artefatos"
    ...
    | --- | --- | --- | --- |
    | 1. Home | [Home](https://requisitos-de-software.github.io/2023.1-Caesb/) | [Carla](https://github.com/ccarlaa) <br> [Raquel](https://github.com/raqueleucaria) <br>[Raquel](https://github.com/raqueleucaria) | [Paulo](https://github.com/PauloVictorFS) <br> [Pedro](https://github.com/pedrobarbosaocb) <br> [Daniel](https://github.com/daniel-de-sousa) |
    | 1. Planejamento | [Aplicativo Selecionado](../Planejamento/aplicativo_escolhido.md) | [Paulo](https://github.com/PauloVictorFS) e [Raquel](https://github.com/raqueleucaria) <br> [Daniel](https://github.com/daniel-de-sousa), [Guilherme](https://github.com/guilhermekishimoto) e [Raquel](https://github.com/raqueleucaria) <br> [Daniel](https://github.com/daniel-de-sousa) <br> [Pedro](https://github.com/pedrobarbosaocb) <br> | [Carla](https://github.com/ccarlaa) <br> [Raquel](https://github.com/raqueleucaria) <br> [Daniel](https://github.com/daniel-de-sousa) |
    ...
    |  | [Cronograma](../Planejamento/cronograma.md) | [Carla](https://github.com/ccarlaa) <br> [Paulo](https://github.com/PauloVictorFS)  | [Raquel](https://github.com/raqueleucaria) |
    |  | [Cronograma Realizado](../Planejamento/cronograma_realizado.md) | [Carla](https://github.com/ccarlaa) e [Pedro](https://github.com/pedrobarbosaocb) | [Paulo](https://github.com/PauloVictorFS), [Raquel](https://github.com/raqueleucaria) e [Daniel](https://github.com/daniel-de-sousa) |
    ...
    | 1. Rastreabilidade | [Pré-Rastreabilidade](../Pre-rastreabilidade/aplicativos_analisados.md) | [Daniel](https://github.com/daniel-de-sousa), [Paulo](https://github.com/PauloVictorFS) e [Raquel](https://github.com/raqueleucaria) <br> [Daniel](https://github.com/daniel-de-sousa) | [Carla](https://github.com/ccarlaa) |
    | 2. Elicitação | [Perfil de Usuário](../Elicitacao/perfil_usuario.md) | [Carla](https://github.com/ccarlaa) e [Daniel](https://github.com/daniel-de-sousa) | [Paulo](https://github.com/PauloVictorFS) |
    |  | [Personas](../Elicitacao/personas.md) | [Carla](https://github.com/ccarlaa) e [Daniel](https://github.com/daniel-de-sousa) | [Paulo](https://github.com/PauloVictorFS) |
    ...
    Tabela 3: Artefatos (Fonte: Raquel, 2023).

    </center>

## Verificação e Validação
Outra parte essencial para o projeto é a de Verificação e Validação, na qual tem como objetivo garantir a qualidade dos artefatos produzidos e consequentemente dos requisitos elicitados. Com isso, a tabela 4 lista todos os artefatos produzidos e os métodos de verificação e validação utilizados.

??? note "Tabela com as Verificações e Validações"
    ...
    Tabela 4: Análise V&V (Fonte: Pedro, 2023).
...
??? note "Tabela com as Ferramentas"
    ...
    Tabela 5: Ferramentas (Fonte: Pedro, 2023).
...
No primeiro ponto de controle, o grupo teve que desenvolver a habilidade de se organizar e projetar um futuro, para que pudesse ser realizado um cronograma capaz de apresentar todas as etapas do desenvolvimento, como também planejar todas as suas reuniões e divisões de trabalho.

No segundo ponto de controle, as habilidades desenvolvidas foram a de elicitação de requisitos, onde ao primeiro momento o grupo desenvolveu a habilidade de avaliar quais dados seriam os melhores a ser coletados por cada situação, assim pode se partir para uma abordagem onde se chegasse até o usuário e conseguisse definir seu perfil, e ao se utilizar das técnicas de introspecção, Questionário, Storytelling conseguiu se fazer um trabalho de elicitação de requisitos.

No terceiro e quarto ponto de controle, foi desenvolvido a habilidade de modelagem de requisitos, aqui o grupo se dispor a utilizar técnicas como cenários, casos de uso, onde a habilidade adquirida foi a de se modelar os requisitos elicitados de diversas formas que permitissem a sua melhor visualização e como estavam inseridos dentro do projeto.

Na quinta e sexta o grupo aprendeu a importância de se verificar e validar o que está sendo feito em um projeto, onde foi desenvolvida essa habilidade essencial através do método de inspeção, desse modo o grupo conseguiu ver como estava o andamento do próprio projeto e corrigir o que estava defeituoso.

Para finalizar, no último ponto de controle foi feito o que é conhecido como matriz de rastreabilidade, nesse momento o grupo conseguiu enxergar melhor como todos os artefatos que já haviam sidos produzidos estavam interligados, e como um dependia do outro, assim tendo uma melhor visão e controle dos requisitos elicitados e como eles caminharam durante todo o projeto.

## Apresentações
Na Tabela 6, estão listadas as apresentações realizadas ao longo do projeto, com seus respectivos participantes e links para o YouTube.
...
??? note "Tabela com as Apresentações"
    ...
    | Pós-rastreabilidade | [Entrega 6](https://www.youtube.com/watch?v=s0_4nb564BY) | [Caetano](https://github.com/caeslucio), [Daniel](https://github.com/daniel-de-sousa), [Guilherme](https://github.com/guilhermekishimoto), [Paulo](https://github.com/PauloVictorFS), [Pedro](https://github.com/pedrobarbosaocb) e [Raquel](https://github.com/raqueleucaria) |

    Tabela 6: Apresentações (Fonte: Pedro, 2023).
...
### Facilidades
- O repositório da disciplina por possuir todos os projetos anteriores, facilitou o entendimento do que era esperado para o projeto atual;
...
| :--------: | :-----: | :----: | :------: | :------: | :----: |
|  03/07/2023 | 04/07/2023 | 1.0 | Criação do Documento | [Caetano](https://github.com/caeslucio), [Daniel](https://github.com/daniel-de-sousa), [Guilherme](https://github.com/guilhermekishimoto), [Paulo](https://github.com/PauloVictorFS), [Pedro](https://github.com/pedrobarbosaocb) e [Raquel](https://github.com/raqueleucaria) | [Raquel](https://github.com/raqueleucaria) |